...
Shofer est un projet communautaire, et nous apprécions profondément chaque contribution. Pour simplifier la collaboration, nous fonctionnons sur une base [d'abord l'issue](#approche-issue-first), ce qui signifie que toutes les [Pull Requests (PRs)](#soumettre-une-pull-request) doivent d'abord être liées à une Issue GitHub. Veuillez lire attentivement ce guide.
...
- **Vérifiez les issues existantes** : Recherchez dans les [Issues GitHub](https://github.com/Arkware/Shofer/issues).
...
- **Vous voulez y travailler ?** Commentez "Claiming" sur l'issue et envoyez un DM à **Hannes Rudolph (`hrudolph`)** sur [Discord](https://discord.gg/shofer) pour être assigné. L'assignation sera confirmée dans le fil de discussion.
...
- Pour la documentation, visitez [Shofer Docs](https://github.com/Arkware/Shofer-Docs).

### Signaler des bugs

- Vérifiez d'abord les rapports existants.
- Créez un nouveau bug en utilisant le [modèle "Rapport de bug"](https://github.com/Arkware/Shofer/issues/new/choose) avec :
...
- **Problèmes de sécurité** : Signalez-les en privé via les [avis de sécurité](https://github.com/Arkware/Shofer/security/advisories/new).
...
```
git clone https://github.com/VOTRE_NOM_UTILISATEUR/Shofer.git
```
...
- Doit faire référence à une Issue GitHub assignée. Pour être assigné : commentez "Claiming" sur l'issue et envoyez un DM à **Hannes Rudolph (`hrudolph`)** sur [Discord](https://discord.gg/shofer). L'assignation sera confirmée dans le fil de discussion.
...
En contribuant, vous acceptez que vos contributions soient sous licence Apache 2.0, conformément à la licence de Shofer.
