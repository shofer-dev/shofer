...
сообщить, связавшись с командой проекта по адресу support@shofer.dev. Все жалобы
...
Этот Кодекс поведения адаптирован из [версии Shofer][cline_coc] [Соглашения о поведении участников][homepage], версия 1.4,
