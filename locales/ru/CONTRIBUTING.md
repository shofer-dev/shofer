...
### 3. Присоединяйтесь к сообществу Shofer

- **Основной:** Присоединяйтесь к нашему [Discord](https://discord.gg/shofer) и напишите личное сообщение **Hannes Rudolph (`hrudolph`)**.
- **Альтернатива:** Опытные участники mogą напрямую взаимодействовать через [Проекты GitHub](https://github.com/orgs/Arkware/projects/1).
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/alsterg/shofer.dev/issues).
...
- **Хотите над этим поработать?** Напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/shofer), чтобы вас назначили. Назначение будет подтверждено в ветке.
- **PR должны ссылаться на задачу.** Несвязанные PR могут быть закрыты.

### Решение, над чем работать

- Проверьте [Проект GitHub](https://github.com/orgs/Arkware/projects/1) на наличие задач «Задача [не назначена]».
- Для документации посетите [Документацию Shofer](https://github.com/alsterg/shofer.dev-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/alsterg/shofer.dev/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией Shofer (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/alsterg/shofer.dev/security/advisories/new).
...
```
git clone https://github.com/ВАШЕ_ИМЯ_ПОЛЬЗОВАТЕЛЯ/Shofer.git
```
...
- Должен ссылаться на назначенную задачу GitHub. Чтобы вас назначили: напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/shofer). Назначение будет подтверждено в ветке.
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Shofer.
