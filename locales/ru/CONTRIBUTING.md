...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/shofer-dev/shofer/issues).
...
- Для документации посетите [Документацию Shofer](https://github.com/shofer-dev/shofer-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/shofer-dev/shofer/issues/new/choose) с:
...
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/shofer-dev/shofer/security/advisories/new).
