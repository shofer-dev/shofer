...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/Arkware/Shofer/issues).
...
- Для документации посетите [Документацию Shofer](https://github.com/Arkware/Shofer-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/Arkware/Shofer/issues/new/choose) с:
...
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/Arkware/Shofer/security/advisories/new).
