...
Shofer és un projecte impulsat per la comunitat i valorem profundament cada contribució. Per agilitzar la col·laboració, operem sobre una base de [primer la incidència](#enfocament-de-primera-incidència), la qual cosa significa que totes les [sol·licituds d'extracció (PR)](#enviament-duna-sollicitud-dextracció) primer han d'estar enllaçades a una incidència de GitHub. Si us plau, reviseu aquesta guia amb atenció.
...
- **Comproveu les incidències existents**: cerqueu a [Incidències de GitHub](https://github.com/Arkware/Shofer/issues).
...
- **Voleu treballar-hi?** Comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/shofer) per ser assignat. L'assignació es confirmarà al fil.
...
- Per a documents, visiteu [Documents de Shofer](https://github.com/Arkware/Shofer-Docs).

### Informar d'errors

- Comproveu primer si hi ha informes existents.
- Creeu un error nou utilitzant la [plantilla "Informe d'error"](https://github.com/Arkware/Shofer/issues/new/choose) amb:
...
- **Problemes de seguretat**: informeu de manera privada a través d' [avisos de seguretat](https://github.com/Arkware/Shofer/security/advisories/new).
...
```
git clone https://github.com/EL_TEU_NOM_USUARI/Shofer.git
```
...
- Ha de fer referència a una incidència de GitHub assignada. Per ser assignat: comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/shofer). L'assignació es confirmarà al fil.
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de Shofer.
