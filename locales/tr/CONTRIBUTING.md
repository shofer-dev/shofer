...
- **Mevcut sorunları kontrol edin**: [GitHub Sorunları](https://github.com/shofer-dev/shofer/issues)nda arama yapın.
- **Bir sorun oluşturun**:
...
- Belgeler için [Shofer Belgeleri](https://github.com/shofer-dev/shofer-Docs)ni ziyaret edin.

### Hataları Bildirme

- Önce mevcut raporları kontrol edin.
- Aşağıdakilerle ["Hata Raporu" şablonunu](https://github.com/shofer-dev/shofer/issues/new/choose) kullanarak yeni bir hata oluşturun:
...
- **Güvenlik sorunları**: [Güvenlik tavsiyeleri](https://github.com/shofer-dev/shofer/security/advisories/new) aracılığıyla özel olarak bildirin.
