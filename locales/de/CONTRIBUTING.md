...
- **Überprüfe bestehende Issues**: Suche in den [GitHub Issues](https://github.com/Arkware/Shofer/issues).
...
- **Möchtest du daran arbeiten?** Kommentiere „Claiming“ im Issue und schreibe eine DM an **Hannes Rudolph (`hrudolph`)** auf [Discord](https://discord.gg/shofer), um zugewiesen zu werden. Die Zuweisung wird im Thread bestätigt.
...
- Für Dokumentation besuche [Shofer Docs](https://github.com/Arkware/Shofer-Docs).

### Fehler melden

- Überprüfe zuerst, ob bereits Berichte vorhanden sind.
- Erstelle einen neuen Fehler mit der [Vorlage „Fehlerbericht“](https://github.com/Arkware/Shofer/issues/new/choose) mit:
...
- **Sicherheitsprobleme**: Melde sie privat über [Sicherheitshinweise](https://github.com/Arkware/Shofer/security/advisories/new).
...
```
git clone https://github.com/DEIN_BENUTZERNAME/Shofer.git
```
...
- Muss auf ein zugewiesenes GitHub-Issue verweisen. Um zugewiesen zu werden: Kommentiere „Claiming“ im Issue und schreibe eine DM an **Hannes Rudolph (`hrudolph`)** auf [Discord](https://discord.gg/shofer). Die Zuweisung wird im Thread bestätigt.
...
Indem du einen Beitrag leistest, stimmst du zu, dass deine Beiträge unter der Apache-2.0-Lizenz lizenziert werden, die mit der Lizenzierung von Shofer übereinstimmt.
