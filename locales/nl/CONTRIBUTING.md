...
- **Controleer bestaande issues**: Zoek in [GitHub Issues](https://github.com/Arkware/Shofer/issues).
...
- Ga voor documentatie naar [Shofer Docs](https://github.com/Arkware/Shofer-Docs).

### Bugs rapporteren

- Controleer eerst bestaande rapporten.
- Maak een nieuwe bug aan met het ["Bugrapport"-sjabloon](https://github.com/Arkware/Shofer/issues/new/choose) met:
...
- **Beveiligingsproblemen**: Rapporteer privé via [beveiligingsadviezen](https://github.com/Arkware/Shofer/security/advisories/new).
