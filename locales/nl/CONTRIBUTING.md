...
# Bijdragen aan Shofer

Shofer is een door de gemeenschap gedreven project en we waarderen elke bijdrage ten zeerste. Om de samenwerking te stroomlijnen, werken we op basis van een [Issue-First-aanpak](#issue-first-aanpak), wat betekent dat alle [Pull Requests (PR's)](#een-pull-request-indienen) eerst gekoppeld moeten zijn aan een GitHub Issue. Lees deze handleiding zorgvuldig door.
...
- **Controleer bestaande issues**: Zoek in [GitHub Issues](https://github.com/shofer-dev/shofer/issues).
...
- **Wil je eraan werken?** Reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://discord.gg/shofer) om toegewezen te worden. De toewijzing wordt in de thread bevestigd.
...
- Ga voor documentatie naar [Shofer Docs](https://github.com/shofer-dev/shofer-Docs).

### Bugs rapporteren

- Controleer eerst bestaande rapporten.
- Maak een nieuwe bug aan met het ["Bugrapport"-sjabloon](https://github.com/shofer-dev/shofer/issues/new/choose) met:
    - Duidelijke, genummerde reproductiestappen
    - Verwacht vs. feitelijk resultaat
    - Shofer-versie (vereist); API-provider/model indien relevant
- **Beveiligingsproblemen**: Rapporteer privé via [beveiligingsadviezen](https://github.com/shofer-dev/shofer/security/advisories/new).
...
```
git clone https://github.com/JOUW_GEBRUIKERSNAAM/Shofer.git
```
...
- Moet verwijzen naar een toegewezen GitHub Issue. Om toegewezen te worden: reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://discord.gg/shofer). De toewijzing wordt in de thread bevestigd.
...
Door bij te dragen, ga je ermee akkoord dat je bijdragen onder de Apache 2.0-licentie worden gelicentieerd, in overeenstemming met de licentieverlening van Shofer.
