...
<p align="center">
  <em>Snel hulp krijgen → <a href="https://discord.gg/shofer">Word lid van Discord</a> • Liever asynchroon? → <a href="https://www.reddit.com/r/Shofer/">Word lid van r/Shofer</a></em>
</p>
...
- Poe toegevoegd als AI-provider, zodat je in Shofer direct toegang hebt tot Poe-modellen.
...
Shofer past zich aan jouw werkwijze aan, niet andersom:
...
Er zijn verschillende manieren om de Shofer-extensie uit te voeren:

### Ontwikkelmodus (F5)

Gebruik voor actieve ontwikkeling de ingebouwde foutopsporing van VSCode:

Druk op `F5` (of ga naar **Uitvoeren** → **Foutopsporing starten**) in VSCode. Dit opent een nieuw VSCode-venster waarin de Shofer-extensie wordt uitgevoerd.
...
1.  Bouw eerst het VSIX-pakket:
    ...
    pnpm vsix
    ```
2.  Een `.vsix`-bestand wordt gegenereerd in de `bin/`-directory (bijv. `bin/shofer-<version>.vsix`).
...
**Veel plezier met Shofer!** Of je het nu strak aan de lijn houdt of autonoom laat rondlopen, we zijn benieuwd wat je bouwt. Vragen of feature-ideeën? Kom langs op onze [Reddit-community](https://www.reddit.com/r/Shofer/) of [Discord](https://discord.gg/shofer). Happy coding!
