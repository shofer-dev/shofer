...
### 3. Tham gia cộng đồng Shofer

- **Chính:** Tham gia [Discord](https://discord.gg/shofer) của chúng tôi và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)**.
- **Thay thế:** Những người đóng góp có kinh nghiệm có thể tham gia trực tiếp qua [Dự án GitHub](https://github.com/orgs/Arkware/projects/1).
...
- **Kiểm tra các vấn đề hiện có**: Tìm kiếm trong [Vấn đề trên GitHub](https://github.com/alsterg/shofer.dev/issues).
...
- **Bạn muốn làm việc với nó?** Bình luận "Nhận" trên vấn đề và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)** trên [Discord](https://discord.gg/shofer) để được giao. Việc giao nhiệm vụ sẽ được xác nhận trong chuỗi.
- **PR phải liên kết đến vấn đề.** Các PR không được liên kết có thể bị đóng.

### Quyết định nên làm gì

- Kiểm tra [Dự án GitHub](https://github.com/orgs/Arkware/projects/1) để tìm các vấn đề "Vấn đề [Chưa được giao]".
- Để biết tài liệu, hãy truy cập [Tài liệu Shofer](https://github.com/alsterg/shofer.dev-Docs).

### Báo cáo lỗi

- Trước tiên hãy kiểm tra các báo cáo hiện có.
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/alsterg/shofer.dev/issues/new/choose) với:
    - Các bước tái tạo rõ ràng, được đánh số
    - Kết quả mong đợi so với thực tế
    - Phiên bản Shofer (bắt buộc); nhà cung cấp/mô hình API nếu có liên quan
- **Vấn đề bảo mật**: Báo cáo riêng tư qua [tư vấn bảo mật](https://github.com/alsterg/shofer.dev/security/advisories/new).
...
```
git clone https://github.com/TÊN_NGƯỜI_DÙNG_CỦA_BẠN/Shofer.git
```
...
- Phải tham chiếu đến một Vấn đề GitHub đã được giao. Để được giao: bình luận "Nhận" trên vấn đề và nhắn tin trực tiếp cho **Hannes Rudolph (`hrudolph`)** trên [Discord](https://discord.gg/shofer). Việc giao nhiệm vụ sẽ được xác nhận trong chuỗi.
...
Bằng cách đóng góp, bạn đồng ý rằng những đóng góp của bạn sẽ được cấp phép theo Giấy phép Apache 2.0, phù hợp với việc cấp phép của Shofer.
