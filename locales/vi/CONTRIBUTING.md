...
- **Kiểm tra các vấn đề hiện có**: Tìm kiếm trong [Vấn đề trên GitHub](https://github.com/Arkware/Shofer/issues).
...
- Để biết tài liệu, hãy truy cập [Tài liệu Shofer](https://github.com/Arkware/Shofer-Docs).

### Báo cáo lỗi

- Trước tiên hãy kiểm tra các báo cáo hiện có.
- Tạo một lỗi mới bằng cách sử dụng [mẫu "Báo cáo lỗi"](https://github.com/Arkware/Shofer/issues/new/choose) với:
...
- **Vấn đề bảo mật**: Báo cáo riêng tư qua [tư vấn bảo mật](https://github.com/Arkware/Shofer/security/advisories/new).
