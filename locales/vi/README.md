...
<p align="center">
  <em>Nhận trợ giúp nhanh → <a href="https://discord.gg/shofer">Tham gia Discord</a> • Thích không đồng bộ? → <a href="https://www.reddit.com/r/Shofer/">Tham gia r/Shofer</a></em>
</p>
...
- Đã thêm Poe làm nhà cung cấp AI để bạn có thể truy cập trực tiếp các model Poe trong Shofer.
...
Shofer thích ứng với cách bạn làm việc, chứ không phải ngược lại:
...
Xem thêm: [Sử dụng Chế độ](https://docs.shofer.dev/basic-usage/using-modes) • [Chế độ tùy chỉnh](https://docs.shofer.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.shofer.dev/tutorial-videos">Thêm video hướng dẫn và tính năng nhanh...</a>
</p>

## Tài nguyên

- **[Tài liệu](https://docs.shofer.dev):** Hướng dẫn chính thức để cài đặt, cấu hình và sử dụng thành thạo Shofer.
...
- **[Vấn đề trên GitHub](https://github.com/shofer-dev/shofer/issues):** Báo cáo lỗi và theo dõi quá trình phát triển.
- **[Yêu cầu tính năng](https://github.com/shofer-dev/shofer/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Có ý tưởng? Hãy chia sẻ với các nhà phát triển.
...
Có một số cách để chạy phần mở rộng Shofer:

### Chế độ phát triển (F5)

Để phát triển tích cực, hãy sử dụng tính năng gỡ lỗi tích hợp của VSCode:

Nhấn `F5` (hoặc vào **Run** → **Start Debugging**) trong VSCode. Thao tác này sẽ mở một cửa sổ VSCode mới với phần mở rộng Shofer đang chạy.
...
1.  Đầu tiên, hãy xây dựng gói VSIX:
    ...
    pnpm vsix
    ```
2.  Một tệp `.vsix` sẽ được tạo trong thư mục `bin/` (ví dụ: `bin/shofer-<version>.vsix`).
...
**Thưởng thức Shofer!** Dù bạn giữ nó trong tầm kiểm soát chặt chẽ hay để nó tự do hoạt động, chúng tôi rất nóng lòng muốn xem bạn sẽ xây dựng được gì. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/Shofer/) hoặc [Discord](https://discord.gg/shofer) của chúng tôi. Chúc bạn viết mã vui vẻ!
