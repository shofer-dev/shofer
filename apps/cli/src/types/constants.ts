...
export const AUTH_BASE_URL = process.env.SHOFER_AUTH_BASE_URL ?? "https://app.shofer.com"

export const SDK_BASE_URL = process.env.SHOFER_SDK_BASE_URL ?? "https://cloud-api.shofer.com"
