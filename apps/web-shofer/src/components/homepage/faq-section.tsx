...
const faqs: FAQItem[] = [
	{
		question: "What exactly is Shofer?",
		answer: (
			<>
				Shofer is an open-source, AI-powered coding assistant that runs in VS Code. It goes beyond simple
	...
	{
		question: "How does Shofer differ from Copilot, Cursor, or Windsurf?",
		answer: (
			<>
				Shofer is <strong>open-source and fully customizable</strong>, letting you integrate any AI model you
				...
				browser, and handle deeper tasks. And you&apos;re always in control: Shofer is{" "}
	...
	{
		question: "Is Shofer really free?",
		answer: (
			<>
				Yes! Shofer is completely free and open-source. You&apos;ll only pay for the AI model usage if you use a
	...
	},
	{
		...
		answer: (
			<>
				Yes. Because Shofer is an extension in your local VS Code, your code never leaves your machine unless
				you connect to an external AI API. Even then, you control exactly what is sent to the AI model. You can
				use tools like .shoferignore to exclude sensitive files, and you can also run Shofer with offline/local
				models for full privacy.
			</>
		),
	},
	{
		question: "Which AI models does Shofer support?",
		answer: (
			<>
				Shofer is fully model-agnostic, giving you the flexibility to work with whatever AI models you prefer.
				...
				connect any other model that follows Shofer&apos;s Model Context Protocol (MCP).
			</>
		),
	},
	{
		question: "Does Shofer support my programming language?",
		answer: (
			<>
				Likely yes! Shofer supports a wide range of languages—Python, Java, C#, JavaScript/TypeScript, Go, Rust,
	...
	},
	{
		...
		answer: (
			<>
				Absolutely. Shofer uses efficient strategies (like partial-file analysis, summarization, or
				...
				<Link href="/enterprise" className="text-primary underline-offset-4 hover:underline">
					Learn more about Shofer for enterprise.
				</Link>
			</>
		),
	},
	{
		...
		answer: (
			<>
				Yes. Shofer was built for enterprise environments. You can self-host AI models or use your own trusted
	...
	{
		question: "Can Shofer run commands and tests automatically?",
		answer: (
			<>
				Yes! One of Shofer&apos;s biggest strengths is its ability to execute commands—always optional and fully
	...
	},
	{
		...
		answer: (
			<>
				Shofer shines for both serious enterprise development and casual &quot;vibe coding.&quot; You can ask it
	...
	{
		question: "Can I contribute to Shofer?",
		answer: (
			<>
				...
				and{" "}
				<a
					href="https://reddit.com/r/Shofer"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					Reddit
	...
	},
	{
		...
		answer: (
			<>
				...
				<a
					href="https://www.youtube.com/@ShoferYT"
					target="_blank"
					rel="noopener noreferrer"
					className="text-primary underline-offset-4 hover:underline">
					YouTube
				...
				<div className="mx-auto mb-24 max-w-3xl text-center">
					<motion.div
						...
						<p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
							Everything you need to know about Shofer and how it can transform your development workflow.
						</p>
					</motion.div>
				</div>
