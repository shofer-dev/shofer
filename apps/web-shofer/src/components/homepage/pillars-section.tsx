			...
			<div className="container px-4 mx-auto sm:px-6 lg:px-8">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-xl mx-auto">
						Shofer is designed from the ground up to give you the confidence to do ever more with AI.
					</p>
				</div>
						...
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									...
									<p>
										Shofer&apos;s Modes keep models focused on a given task and limit their access
										to tools which are relevant to their role, keeping the context window clearer
						...
						<div className="rounded-2xl bg-card outline outline-border/50 hover:outline-8 shadow-lg p-8 h-full group transition-all hover:shadow-2xl">
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									...
									<p>We made Shofer thoughtfully configurable to fit your workflow as best it can.</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div>
								...
								<div className="text-muted-foreground my-4 space-y-1">
									<p>
										...
										<Link target="_blank" href="https://github.com/Arkware/Shofer">
											open source
										</Link>{" "}
