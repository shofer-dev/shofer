...
export function SlackThreadDemo({ className }: SlackThreadDemoProps): JSX.Element {
		...
		() => [
			{
				...
				kind: "human",
				body: <span>We need to add a page to our Marketing site that highlights using Shofer from Slack.</span>,
			},
			{
				id: "m2",
				author: "Avery Lee",
			...
			},
			{
				...
				body: (
					<div className="space-y-3">
						<p>
							I&apos;ve created a comprehensive implementation plan for the Shofer Slack integration
							marketing page at{" "}
							<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
			...
			},
			{
				...
				body: (
					<div className="space-y-3">
						<p>
							I&apos;ve built the Shofer Slack integration marketing page. Here&apos;s what was
							implemented:
						</p>
						...
						<div className="rounded-lg border border-white/10 bg-black/20 px-3 py-2">
							...
							<ul className="mt-2 space-y-1 text-[#D1D2D3]">
								<li>
									<span className="mr-2">•</span>
									<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
										apps/web-shofer-code/src/app/slack/page.tsx
									</code>{" "}
								...
								<li>
									<span className="mr-2">•</span>
									<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
										apps/web-shofer-code/src/lib/constants.ts
									</code>{" "}
									— added{" "}
									<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
										SLACK_DOCS
								...
								<li>
									<span className="mr-2">•</span>
									<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
										apps/web-shofer-code/src/components/chromes/nav-bar.tsx
									</code>{" "}
						...
						<div className="rounded-lg border border-white/10 bg-black/20 px-3 py-2">
							...
							<div className="mt-2">
								...
								<FakeLink className="hover:text-violet-200">
									https://github.com/Arkware/Shofer/pull/10853
								</FakeLink>
							</div>
						</div>
	...
	return (
		<div
			...
			role="img"
			aria-label="Animated Slack thread showing Shofer responding as @Roomote">
			<div
				aria-hidden="true"
