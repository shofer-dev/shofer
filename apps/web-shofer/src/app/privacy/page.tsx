...
const DESCRIPTION =
	"Privacy policy for Shofer Cloud and marketing website. Learn how we handle your data and protect your privacy."
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Shofer Cloud Privacy Policy
					</h1>
					<p className="text-muted-foreground">Last Updated: September 19, 2025</p>

					<p className="lead">
						This Privacy Policy explains how Shofer, Inc. (&quot;Shofer,&quot; &quot;we,&quot;
					...
					<div className="my-8 rounded-lg border border-border bg-muted/50 p-6">
						...
						<p className="mb-0">
							...
							<a
								...
								Shofer Extension Privacy Policy
							</a>
							.
						</p>
					</div>
					...
					<ul>
						<li>
							<strong>
								Your source code does not transit Shofer servers unless you explicitly choose Shofer as
								a model provider (proxy mode).
							</strong>{" "}
							When Shofer Cloud is your model provider, your code briefly transits Shofer servers only to
							...
							TLS—to the model you select. Shofer never stores, inspects, or trains on your code.
						</li>
						<li>
							<strong>Prompts and chat snippets are collected by default</strong> in Shofer Cloud so you
							can search and re‑use past conversations. Organization admins can disable this collection at
							any time.
						</li>
						<li>
							We collect only the data needed to operate Shofer Cloud, do <strong>not</strong> sell
					...
					<ul>
						<li>
							<strong>Operate & secure Shofer Cloud</strong> (authentication, completions, abuse
							prevention)
						</li>
						<li>
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Your chosen model provider (direct client → provider TLS), or Shofer (proxy
										mode; transit‑only) when you select Shofer as the provider
									</td>
									<td className="border border-border px-4 py-2">
										Shofer servers (except proxy mode; transit‑only, no storage); ad networks;
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">Shofer Cloud (encrypted at rest)</td>
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Shofer servers (we store only the Stripe customer ID)
									</td>
								</tr>
							</tbody>
						</table>
					...
					<ul>
						<li>
							<strong>Source Code:</strong> Never stored on Shofer servers.
						</li>
						<li>
					...
					<ul>
						...
						<li>
							...
							<strong>Security Settings</strong> inside Shofer Cloud (User Menu &rarr; My Settings &rarr;
							Open Profile).
						</li>
						<li>
