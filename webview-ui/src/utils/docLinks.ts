/**
 * Utility for building Shofer documentation links with UTM telemetry.
 *
...
export function buildDocLink(path: string, campaign: string): string {
	...
	const baseUrl = `https://shofer.dev/docs/${basePath}?utm_source=extension&utm_medium=ide&utm_campaign=${encodeURIComponent(campaign)}`
