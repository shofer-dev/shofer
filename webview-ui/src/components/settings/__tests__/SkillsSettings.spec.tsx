...
const mockSkills: SkillMetadata[] = [
	{
		...
		path: "/workspace/.shofer/skills/project-skill/SKILL.md",
		source: "project",
	},
	{
		name: "project-mode-skill",
		description: "A project mode-specific skill",
		path: "/workspace/.shofer/skills/project-mode-skill/SKILL.md",
		source: "project",
		modeSlugs: ["architect"],
	},
	{
		...
		path: "/home/.shofer/skills/global-skill/SKILL.md",
		source: "global",
	},
]
