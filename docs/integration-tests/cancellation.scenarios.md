...
> Feature doc: [`docs/cancellation.md`](../cancellation.md)
...
> [`McpHub.ts`](../../packages/core/src/services/mcp/McpHub.ts) (callTool, readResource with signal),
> `mcp-server/mcp.go` (in-flight registry, handleCancelledNotification)
