...
Sources: [`ShoferIgnoreController`](../../packages/core/src/ignore/ShoferIgnoreController.ts), [`ShoferProtectedController`](../../packages/core/src/protect/ShoferProtectedController.ts), [`CustomModesManager`](../../src/core/config/CustomModesManager.ts), [`shofer_special_files.md`](../shofer_special_files.md).
