...
When a task runs inside an embedded worktree on Linux, `execute_command` prepends the `shofer-sandbox` wrapper binary ([`src/sandbox/main.go`](../src/sandbox/main.go)) to the shell command. The wrapper:
...
**Key files:** [`getWorktreeSandboxPrefix()`](../packages/core/src/utils/worktreePathGuard.ts), [`src/sandbox/main.go`](../src/sandbox/main.go)
