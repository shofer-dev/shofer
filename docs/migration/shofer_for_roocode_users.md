...
| **[`rag_search`](../../plugins/rag-indexing/src/main.ts)**                          | Semantic code search using embedded vectors. Finds files by meaning rather than exact text matches. See §18.                                                                                    |
| **[`git_search`](../../plugins/rag-indexing/src/main.ts)**                          | Semantic search over git commit history — discover _why_ and _when_ changes were made. See §18.                                                                                                 |
...
See [`plugins/basics/docs/file-changes.md`](../../plugins/basics/docs/file-changes.md) for the complete tracking specification.
...
See [`plugins/basics/docs/worktrees.md`](../../plugins/basics/docs/worktrees.md) for the full architecture.
...
| Feature                                                    | Description                                                                                                                                                                                                                                                |
| ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **[`rag_search`](../../plugins/rag-indexing/src/main.ts)** | Semantic code search using embedded vectors. Finds files by meaning rather than exact text matches.                                                                                                                                                        |
| **[`git_search`](../../plugins/rag-indexing/src/main.ts)** | Semantic search over git commit history (commit messages only). Discover _why_ and _when_ changes were made, not just _what_.                                                                                                                              |
...
| **Read-only tool set**             | The live memory is **strictly read-only** — [`tool-executor.ts`](../../plugins/live-memory/tool-executor.ts) restricts it to `TOOL_GROUPS.read` only (file reading, search, LSP lookups). No write, execute, MCP, or task-control tools. |
