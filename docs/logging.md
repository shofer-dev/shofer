...
| Tests              | [`packages/core/src/logging/__tests__/`](../src/utils/logging/__tests__/)                                             | `CompactLogger.spec.ts` (15 tests), `CompactTransport.spec.ts` (12 tests, incl. late channel-binding regression), `index.spec.ts` (3 tests, eager-init regression) |
