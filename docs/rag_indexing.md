...
| -------------------- | ----------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------ |
| `.js` `.jsx` `.json` | JavaScript        | [`javascript.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/javascript.ts)               | `@name` / `@definition.xxx` (no `.definition` on name)            | Tree-sitter WASM                                       |
| `.ts`                | TypeScript        | [`typescript.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/typescript.ts)               | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.tsx`               | TSX               | [`tsx.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/tsx.ts)                             | `@name` / `@definition.xxx` (no `.definition` on name)            | Tree-sitter WASM                                       |
| `.py`                | Python            | [`python.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/python.ts)                       | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.rs`                | Rust              | [`rust.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/rust.ts)                           | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.go`                | Go                | [`go.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/go.ts)                               | `@definition.xxx` only (no name captures)                         | Tree-sitter WASM                                       |
| `.c` `.h`            | C                 | [`c.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/c.ts)                                 | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.cpp` `.hpp`        | C++               | [`cpp.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/cpp.ts)                             | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.cs`                | C#                | [`c-sharp.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/c-sharp.ts)                     | `@name` / `@definition.xxx` (no `.definition` on name)            | Tree-sitter WASM                                       |
| `.rb`                | Ruby              | [`ruby.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/ruby.ts)                           | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.java`              | Java              | [`java.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/java.ts)                           | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.php`               | PHP               | [`php.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/php.ts)                             | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.swift`             | Swift             | [`swift.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/swift.ts)                         | `@name` / `@definition.xxx` (no `.definition` on name)            | Fallback chunking (parser instability)                 |
| `.kt` `.kts`         | Kotlin            | [`kotlin.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/kotlin.ts)                       | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.css`               | CSS               | [`css.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/css.ts)                             | `@name.definition.xxx` / `@_xxx`                                  | Tree-sitter WASM                                       |
| `.html` `.htm`       | HTML              | [`html.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/html.ts)                           | `@name.definition` / `@definition.xxx`                            | Tree-sitter WASM (shared parser, `parserKey = "html"`) |
| `.ml` `.mli`         | OCaml             | [`ocaml.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/ocaml.ts)                         | `@name.definition` / `@definition.xxx`                            | Tree-sitter WASM                                       |
| `.scala`             | Scala             | [`scala.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/scala.ts)                         | `@name.definition` / `@definition.xxx`                            | Tree-sitter WASM                                       |
| `.sol`               | Solidity          | [`solidity.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/solidity.ts)                   | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.toml`              | TOML              | [`toml.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/toml.ts)                           | `@definition` only (no name captures)                             | Tree-sitter WASM                                       |
| `.vue`               | Vue               | [`vue.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/vue.ts)                             | `@xxx.name.definition` / `@xxx.definition` (reversed)             | Tree-sitter WASM                                       |
| `.lua`               | Lua               | [`lua.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/lua.ts)                             | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.rdl`               | SystemRDL         | [`systemrdl.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/systemrdl.ts)                 | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.tla`               | TLA⁺              | [`tlaplus.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/tlaplus.ts)                     | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM                                       |
| `.zig`               | Zig               | [`zig.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/zig.ts)                             | `@name` / `@xxx.definition` (no `.definition` on name)            | Tree-sitter WASM                                       |
| `.ejs` `.erb`        | Embedded Template | [`embedded_template.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/embedded_template.ts) | `@name.definition.xxx` / `@definition.xxx`                        | Tree-sitter WASM (`parserKey = "embedded_template"`)   |
| `.el`                | Emacs Lisp        | [`elisp.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/elisp.ts)                         | `@name.definition.xxx` / `@_xxx`                                  | Tree-sitter WASM                                       |
| `.ex` `.exs`         | Elixir            | [`elixir.ts`](extensions/shofer/packages/core/src/services/tree-sitter/queries/elixir.ts)                       | Raw captures (`@function`, `@definition.xxx` — no `name.` prefix) | Tree-sitter WASM                                       |
...
Extensions in `fallbackExtensions` ([`supported-extensions.ts`](extensions/shofer/src/services/code-index/shared/supported-extensions.ts:21)) are detected before tree-sitter dispatch by [`shouldUseFallbackChunking()`](extensions/shofer/src/services/code-index/shared/supported-extensions.ts:32). They never reach [`loadRequiredLanguageParsers()`](extensions/shofer/packages/core/src/services/tree-sitter/languageParser.ts:80) on the indexing path. Note that `loadRequiredLanguageParsers()` throws `Unsupported language: <ext>` at its `default:` case for any extension with no `case` (e.g. `.vb`, `.elm`; `.swift` actually has a live `case`). The other caller of the tree-sitter path, [`parseSourceCodeDefinitionsForFile`](extensions/shofer/packages/core/src/services/tree-sitter/index.ts) (used by [`foldedFileContext.ts`](extensions/shofer/packages/core/src/condense/foldedFileContext.ts) for context condensing — there is no `list_code_definition_names` tool in this codebase), **wraps the parse in try/catch and counts the file as skipped**, so a fallback/unsupported extension is silently skipped rather than crashing.
...
| Point             | File                                                                              | Details                                                                 |
| ----------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| Tool registration | `packages/core/src/task/build-tools.ts:258-259`                                   | Gets `CodeIndexManager` for current workspace, passes to tool filter    |
| Tool filtering    | `packages/core/src/prompts/tools/filter-tools-for-mode.ts:271-277`                | Removes `rag_search` if indexing is disabled/unconfigured/uninitialized |
| Tool dispatch     | `packages/core/src/assistant-message/presentAssistantMessage.ts:850-853, 871-874` | Routes to `RagSearchTool` or `LspSearchTool`                            |
| Auto-approval     | `packages/core/src/auto-approval/tools.ts:20`                                     | `ragSearch` is auto-approved by default                                 |
| System prompt     | `packages/core/src/prompts/system.ts:72`                                          | Includes indexing status in system prompt context                       |
