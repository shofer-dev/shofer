...
export const IMAGE_GENERATION_MODELS: ImageGenerationModel[] = [
	...
	// Shofer Cloud models
	{ value: "google/gemini-2.5-flash-image", label: "Gemini 2.5 Flash Image", provider: "shofer" },
	{ value: "google/gemini-3-pro-image", label: "Gemini 3 Pro Image", provider: "shofer" },
	{
 ...
 */
export type ImageGenerationProvider = "openrouter" | "shofer"
 ...
 * - Otherwise default to "shofer" (new users)
 */
export function getImageGenerationProvider(
	explicitProvider: ImageGenerationProvider | undefined,
	hasExistingModel: boolean,
): ImageGenerationProvider {
	return explicitProvider !== undefined ? explicitProvider : hasExistingModel ? "openrouter" : "shofer"
}
