/**
 * Validates the generated schemas/shofermodes.json against sample configurations
 * using AJV. The schema itself is dynamically generated from the Zod types in
 * packages/types/src/mode.ts -- see packages/types/scripts/generate-shofermodes-schema.ts.
 *
 * A separate drift-detection test (shofermodes-schema-sync.spec.ts) ensures the
...
describe("shofermodes JSON schema", () => {
	...
	it("should accept a minimal valid .shofermodes config", () => {
		const config = {
			customModes: [
				{
					slug: "my-mode",
