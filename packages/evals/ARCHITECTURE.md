...
- **Environment Setup**: Launches VS Code with Shofer extension in isolated container
...
- **Development Tools**: VS Code with language-specific extensions and Shofer extension
