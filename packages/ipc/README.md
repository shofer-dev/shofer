...
This package provides IPC functionality for Shofer, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: Shofer settings object
...
- Unix/Linux/macOS: `/tmp/shofer-code-{id}.sock`
- Windows: `\\.\pipe\shofer-code-{id}`
