...
import { readFileTool, ReadFileTool } from "../ReadFileTool.js"
import { formatResponse } from "../../prompts/responses.js"
import { validateImageForProcessing, processImageFile, isSupportedImageFormat, ImageMemoryTracker } from "../helpers/imageHelpers.js"
import { extractTextFromFile, addLineNumbers, getSupportedBinaryFormats } from "../../integrations/misc/extract-text.js"
import { readWithIndentation, readWithSlice } from "../../integrations/misc/indentation-reader.js"
...
vi.mock("../../integrations/misc/indentation-reader.js", async (importOriginal) => ({
	...(await importOriginal<typeof import("../../integrations/misc/indentation-reader.js")>()),
	readWithIndentation: vi.fn(),
	readWithSlice: vi.fn(),
}))
vi.mock("../helpers/imageHelpers.js", async (importOriginal) => ({
	...(await importOriginal<typeof import("../helpers/imageHelpers.js")>()),
...
describe("ReadFileTool", () => {
	...
	describe("ShoferIgnore handling", () => {
		it("should block access to rooignore-protected files", async () => {
			...
			expect(mockTask.say).toHaveBeenCalledWith("shoferignore_error", "secret.env")
