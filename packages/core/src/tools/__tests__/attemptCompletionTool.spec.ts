...
// imports — a barrel `vi.mock("@shofer/core")` can no longer intercept them. Mock
// the intra-core collaborators core-relative instead, and drive config via the host.
