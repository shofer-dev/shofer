...
import { resolveImageMentions } from "../resolveImageMentions.js"

vi.mock("../../tools/helpers/imageHelpers.js", async (importOriginal) => ({
	...(await importOriginal<typeof import("../../tools/helpers/imageHelpers.js")>()),
...
import { validateImageForProcessing, readImageAsDataUrlWithBuffer } from "../../tools/helpers/imageHelpers.js"
...
describe("resolveImageMentions", () => {
	...
	it("should respect shoferIgnoreController", async () => {
		...
		expect(shoferIgnoreController.validateAccess).toHaveBeenCalledWith("secret.jpg")
		expect(mockReadImageAsDataUrl).not.toHaveBeenCalled()
		expect(result.images).toEqual([])
	})
