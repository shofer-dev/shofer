...
import { loadRequiredLanguageParsers } from "../../../../services/tree-sitter/languageParser.js"
...
vi.mock("../../../../services/tree-sitter/languageParser.js", async (importOriginal) => ({
	...(await importOriginal<typeof import("../../../../services/tree-sitter/languageParser.js")>()),
	loadRequiredLanguageParsers: vi.fn(),
}))
vi.mock("../../../../services/tree-sitter/markdownParser.js", async (importOriginal) => ({
	...(await importOriginal<typeof import("../../../../services/tree-sitter/markdownParser.js")>()),
	parseMarkdown: vi.fn(),
}))
