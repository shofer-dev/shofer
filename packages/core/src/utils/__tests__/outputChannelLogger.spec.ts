...
import { createOutputChannelLogger, createDualLogger, stringifyForLog } from "../outputChannelLogger.js"

// Structural output channel (host-agnostic; a vscode.OutputChannel satisfies this too)
const mockOutputChannel = {
	appendLine: vitest.fn(),
} as unknown as OutputChannelLike
