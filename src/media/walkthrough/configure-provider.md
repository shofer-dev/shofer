...
Shofer works with virtually any AI model. Choose from Anthropic, OpenAI, Google Gemini, DeepSeek, OpenRouter, Ollama (local), and many more.

## Quick Setup

1. Click **Open Settings** in the step description
2. Navigate to the **Providers** tab
3. Click **New Profile** and choose your provider
