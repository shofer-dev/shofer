...
import { MultiPointStrategy, type CacheModelInfo } from "@shofer/core"
import { convertToBedrockConverseMessages as sharedConverter } from "@shofer/core"
...
export class AwsBedrockHandler extends BaseProvider implements SingleCompletionHandler {
	...
	private parseArn(arn: string, region?: string) {
		/*
		 * VIA Shofer analysis: platform-independent Regex. It's designed to parse Amazon Bedrock ARNs and doesn't rely on any platform-specific features
