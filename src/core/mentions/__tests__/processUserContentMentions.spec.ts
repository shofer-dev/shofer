...
describe("processUserContentMentions", () => {
	...
	let mockShoferIgnoreController: any

	beforeEach(() => {
		vi.clearAllMocks()

		mockFileContextTracker = {} as FileContextTracker
		mockShoferIgnoreController = {}
	...
	describe("showShoferIgnoredFiles parameter", () => {
		it("should default showShoferIgnoredFiles to false", async () => {
			const userContent = [
				{
					type: "text" as const,
			...
			expect(parseMentions).toHaveBeenCalledWith(
				...
				undefined,
				false, // showShoferIgnoredFiles should default to false
		...
		it("should respect showShoferIgnoredFiles when explicitly set to false", async () => {
			const userContent = [
				{
					type: "text" as const,
