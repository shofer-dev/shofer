...
describe("loadRuleFiles", () => {
	...
	it("should read and trim file content", async () => {
		// Simulate no .shofer/rules directory
	...
	it("should not combine content from multiple rule files when they exist", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().endsWith(".roorules")) {
				return Promise.resolve("shofer rules content")
			}
	...
	it("should use .shofer/rules/ directory when it exists and has files", async () => {
		// Simulate .shofer/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				parentPath: "/fake/path/.shofer/rules",
			},
			{
				name: "file2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.shofer/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.shofer/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.shofer/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/file2.txt") {
		...
		const expectedRelativePath1 =
			process.platform === "win32" ? ".shofer\\rules\\file1.txt" : ".shofer/rules/file1.txt"
		const expectedRelativePath2 =
			process.platform === "win32" ? ".shofer\\rules\\file2.txt" : ".shofer/rules/file2.txt"
		...
		const expectedRulesDir =
			process.platform === "win32" ? "\\fake\\path\\.shofer\\rules" : "/fake/path/.shofer/rules"
		const expectedFile1Path =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules\\file1.txt"
				: "/fake/path/.shofer/rules/file1.txt"
		const expectedFile2Path =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules\\file2.txt"
				: "/fake/path/.shofer/rules/file2.txt"
	...
	it("should filter out cache files from .shofer/rules/ directory", async () => {
		// Simulate .shofer/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.shofer/rules/rule1.txt") {
				return Promise.resolve("rule 1 content")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/rule2.md") {
			...
			if (normalizedPath === "/fake/path/.shofer/rules/.DS_Store") {
				return Promise.resolve("DS_STORE_BINARY_CONTENT")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/Thumbs.db") {
				return Promise.resolve("THUMBS_DB_CONTENT")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/backup.bak") {
				return Promise.resolve("BACKUP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/cache.log") {
				return Promise.resolve("LOG_CONTENT")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/temp.tmp") {
				return Promise.resolve("TEMP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/script.pyc") {
		...
		const expectedCacheFiles = [
			"/fake/path/.shofer/rules/.DS_Store",
			"/fake/path/.shofer/rules/Thumbs.db",
			"/fake/path/.shofer/rules/backup.bak",
			"/fake/path/.shofer/rules/cache.log",
			"/fake/path/.shofer/rules/temp.tmp",
			"/fake/path/.shofer/rules/script.pyc",
		]
	...
	it("should fall back to .roorules when .shofer/rules/ is empty", async () => {
		// Simulate .shofer/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .shofer/rules/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.shofer/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.shofer/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.shofer/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRelativeRootPath =
			process.platform === "win32" ? ".shofer\\rules\\root.txt" : ".shofer/rules/root.txt"
		const expectedRelativeNested1Path =
			process.platform === "win32" ? ".shofer\\rules\\subdir\\nested1.txt" : ".shofer/rules/subdir/nested1.txt"
		const expectedRelativeNested2Path =
			process.platform === "win32"
				? ".shofer\\rules\\subdir\\subdir2\\nested2.txt"
				: ".shofer/rules/subdir/subdir2/nested2.txt"
		...
		const expectedRootPath2 =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules\\root.txt"
				: "/fake/path/.shofer/rules/root.txt"
		const expectedNested1Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules\\subdir\\nested1.txt"
				: "/fake/path/.shofer/rules/subdir/nested1.txt"
		const expectedNested2Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.shofer/rules/subdir/subdir2/nested2.txt"
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .shofer/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should include AGENTS.md content along with other rules", async () => {
		...
		expect(result).toContain("Shofer rules content")
	})
	...
	it("should use .shofer/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .shofer/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.shofer/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			if (
				normalizedPath.includes("/fake/path/.shofer/rules-test-mode/rule1.txt") ||
				normalizedPath.includes("/fake/path/.shofer/rules-test-mode/rule2.txt")
			) {
				return Promise.resolve({
					isFile: vi.fn().mockReturnValue(true),
				}) as any
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.shofer/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (normalizedPath === "/fake/path/.shofer/rules-test-mode/rule2.txt") {
		...
		const expectedRelativeRule1Path =
			process.platform === "win32" ? ".shofer\\rules-test-mode\\rule1.txt" : ".shofer/rules-test-mode/rule1.txt"
		const expectedRelativeRule2Path =
			process.platform === "win32" ? ".shofer\\rules-test-mode\\rule2.txt" : ".shofer/rules-test-mode/rule2.txt"
		...
		const expectedAbsTestModeDir =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules-test-mode"
				: "/fake/path/.shofer/rules-test-mode"
		const expectedAbsRule1Path =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules-test-mode\\rule1.txt"
				: "/fake/path/.shofer/rules-test-mode/rule1.txt"
		const expectedAbsRule2Path =
			process.platform === "win32"
				? "\\fake\\path\\.shofer\\rules-test-mode\\rule2.txt"
				: "/fake/path/.shofer/rules-test-mode/rule2.txt"
	...
	it("should fall back to .roorules-test-mode when .shofer/rules-test-mode/ does not exist", async () => {
		// Simulate .shofer/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should fall back to .clinerules-test-mode when .shofer/rules-test-mode/ and .roorules-test-mode do not exist", async () => {
		// Simulate .shofer/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (filePath.toString().includes(".clinerules-test-mode")) {
				return Promise.resolve("mode specific rules from shofer file")
			}
			return Promise.reject({ code: "ENOENT" })
		})
		...
		expect(result).toContain("Rules from .clinerules-test-mode:\nmode specific rules from shofer file")
	})

	it("should correctly format content from directories when using .shofer/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
			...
			.mockResolvedValueOnce([
				{
					...
					isFile: () => true,
					parentPath: "/fake/path/.shofer/rules/symlink-target-dir",
				},
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.shofer/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: vi.fn().mockReturnValue(true),
					isFile: vi.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.shofer/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (normalizedPath === "/fake/path/.shofer/symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (normalizedPath === "/fake/path/.shofer/nested-symlink-target.txt") {
		...
		const expectedRelativeRegularPath =
			process.platform === "win32" ? ".shofer\\rules\\regular.txt" : ".shofer/rules/regular.txt"
		const expectedRelativeSymlinkPath =
			process.platform === "win32" ? ".shofer\\symlink-target.txt" : ".shofer/symlink-target.txt"
		const expectedRelativeSubdirPath =
			process.platform === "win32"
				? ".shofer\\rules\\symlink-target-dir\\subdir_link.txt"
				: ".shofer/rules/symlink-target-dir/subdir_link.txt"
		const expectedRelativeNestedPath =
			process.platform === "win32" ? ".shofer\\nested-symlink-target.txt" : ".shofer/nested-symlink-target.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.shofer/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.shofer/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.shofer/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.shofer/symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith(
			"/fake/path/.shofer/rules/symlink-target-dir/subdir_link.txt",
			"utf-8",
		)
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.shofer/nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		vi.clearAllMocks()
	})
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			expect([
				"/fake/path/.shofer/rules/file1.txt",
				"/fake/path/.shofer/rules/file2.txt",
				"/fake/path/.shofer/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.shofer/rules/file3.txt") {
		...
		const expectedRelativeFile3Path =
			process.platform === "win32" ? ".shofer\\rules\\file3.txt" : ".shofer/rules/file3.txt"
	...
	it("should return files in alphabetical order by filename", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "zebra.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules" },
			{ name: "alpha.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules" },
			{ name: "Beta.txt", isFile: () => true, parentPath: "/fake/path/.shofer/rules" }, // Test case-insensitive sorting
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			const pathStr = filePath.toString()
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.shofer/rules/zebra.txt") {
				return Promise.resolve("zebra content")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/alpha.txt") {
				return Promise.resolve("alpha content")
			}
			if (normalizedPath === "/fake/path/.shofer/rules/Beta.txt") {
		...
		const expectedRelativeAlphaPath =
			process.platform === "win32" ? ".shofer\\rules\\alpha.txt" : ".shofer/rules/alpha.txt"
		const expectedRelativeBetaPath =
			process.platform === "win32" ? ".shofer\\rules\\Beta.txt" : ".shofer/rules/Beta.txt"
		const expectedRelativeZebraPath =
			process.platform === "win32" ? ".shofer\\rules\\zebra.txt" : ".shofer/rules/zebra.txt"
	...
	it("should sort symlinks by their symlink names, not target names", async () => {
		...
		// First call: check if .shofer/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
