 ...
 * appended to the Roo Code extension output channel for the user (and
 * developers) to inspect, and is acknowledged back to the model.
 */

const GIVE_FEEDBACK_DESCRIPTION = `Send feedback to the Arkware developers. Use this tool to report issues, suggest improvements, or provide any other feedback about the Arkware platform and its tools. The feedback is appended to the Roo Code output channel.`
