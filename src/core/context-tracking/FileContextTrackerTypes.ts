...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "shofer_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	shofer_read_date: z.number().nullable(),
	shofer_edit_date: z.number().nullable(),
