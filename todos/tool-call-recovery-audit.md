...
- Alias maps: [`packages/types/src/tool.ts`](../packages/types/src/tool.ts) (`TOOL_ALIASES`, `CROSS_ASSISTANT_ALIASES`), [`filter-tools-for-mode.ts`](../extensions/shofer/src/core/prompts/tools/filter-tools-for-mode.ts) (`resolveToolAlias`)
