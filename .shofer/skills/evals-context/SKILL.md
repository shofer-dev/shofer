---
name: evals-context
description: Provides context about the Shofer evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-shofer-code/src/app/evals).
---
...
### `apps/web-shofer-code/src/app/evals/` - Public Website Evals Page

```
apps/web-shofer-code/src/app/evals/
...
- **Runner**: Isolated Docker container with VS Code + Shofer extension + language runtimes
...
- Used by both `apps/web-evals` and `apps/web-shofer-code`
