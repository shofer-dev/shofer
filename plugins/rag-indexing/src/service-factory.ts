...
import { getDefaultModelId, getModelDimension } from "./core-shared.js"
import { ShoferIgnoreController } from "./core-shared.js"
import { OpenAiEmbedder } from "./engine/embedders/openai.js"
import { CodeIndexOllamaEmbedder } from "./engine/embedders/ollama.js"
import { OpenAICompatibleEmbedder } from "./engine/embedders/openai-compatible.js"
import { GeminiEmbedder } from "./engine/embedders/gemini.js"
import { MistralEmbedder } from "./engine/embedders/mistral.js"
import { VercelAiGatewayEmbedder } from "./engine/embedders/vercel-ai-gateway.js"
import { BedrockEmbedder } from "./engine/embedders/bedrock.js"
import { OpenRouterEmbedder } from "./engine/embedders/openrouter.js"
import { getEmbedderLane } from "./engine/embedders/embedder-lane.js"
import { SerializedEmbedder } from "./engine/embedders/serialized-embedder.js"
import { QdrantVectorStore } from "./engine/vector-store/qdrant-client.js"
import { codeParser, DirectoryScanner, FileWatcher } from "./indexing/index.js"
import { ICodeParser, IEmbedder, IFileWatcher, IVectorStore } from "./engine/interfaces/index.js"
...
import { retryWithBackoff } from "./engine/shared/retry.js"
import { incCodeIndexError, setting } from "./plugin-runtime.js"
/**
...
export class CodeIndexServiceFactory {
	...
	public async validateEmbedder(embedder: IEmbedder): Promise<{ valid: boolean; error?: string }> {
		...
		try {
			...
			incCodeIndexError("validateEmbedder")
	...
	public createDirectoryScanner(
		...
		// How many code segments go in one embedding request (plugin setting).
		const batchSize = setting("embeddingBatchSize", BATCH_SEGMENT_THRESHOLD)
