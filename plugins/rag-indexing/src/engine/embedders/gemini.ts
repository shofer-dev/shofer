...
import { GEMINI_MAX_ITEM_TOKENS } from "../constants/index.js"
...
export class GeminiEmbedder implements IEmbedder {
	...
	async createEmbeddings(texts: string[], model?: string): Promise<EmbeddingResponse> {
		try {
			...
			incCodeIndexError("GeminiEmbedder:createEmbeddings")
			throw error
		}
	}
	...
	async validateConfiguration(): Promise<{ valid: boolean; error?: string }> {
		try {
			...
			incCodeIndexError("GeminiEmbedder:validateConfiguration")
			throw error
		}
	}
