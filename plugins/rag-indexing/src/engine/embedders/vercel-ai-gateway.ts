...
import { MAX_ITEM_TOKENS } from "../constants/index.js"
...
export class VercelAiGatewayEmbedder implements IEmbedder {
	...
	async createEmbeddings(texts: string[], model?: string): Promise<EmbeddingResponse> {
		try {
			...
			incCodeIndexError("VercelAiGatewayEmbedder:createEmbeddings")
			throw error
		}
	}
	...
	async validateConfiguration(): Promise<{ valid: boolean; error?: string }> {
		try {
			...
			incCodeIndexError("VercelAiGatewayEmbedder:validateConfiguration")
			throw error
		}
	}
