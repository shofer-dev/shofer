...
// Assert on translation KEYS, not copy: the plugin ships the real `embeddings:`
// strings, and a logic test should not break when one is reworded.
vi.mock("../../../i18n.js", () => ({ t: (key: string) => key, setLanguage: () => {} }))
