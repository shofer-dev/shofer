...
import { loadRequiredLanguageParsers } from "../../../core-shared.js"
...
// The tree-sitter loader is one of the pure helpers this plugin borrows from core
// (`core-shared.ts`); partial-mock only its parsing entry point.
