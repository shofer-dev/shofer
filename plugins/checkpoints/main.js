	...
	"../../node_modules/.pnpm/simple-git@3.27.0/node_modules/simple-git/dist/cjs/index.js"(exports, module) {
		...
		function gitInstanceFactory(baseDir, options) {
			...
			customBinaryPlugin(
				plugins,
				config2.binary,
				(_a2 = config2.unsafe) == null ? void 0 : _a2.allowUnsafeCustomBinary,
			)
...
var getLfsPatterns = async (workspacePath) => {
	try {
		...
		if (await fileExistsAtPath(attributesPath)) {
			return (await fs2.readFile(attributesPath, "utf8"))
				.split("\n")
	...
	async getDiff({ from, to }) {
		...
		for (const file of files) {
			...
			const after = to
				...
				: await fs3.readFile(absPath, "utf8").catch(() => "")
...
export { FILE_MUTATING_TOOLS, main_default as default, resolveDiffRange }
